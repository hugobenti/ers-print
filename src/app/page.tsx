...
export default function Home() {
  ...
  const [carroucelInterval, setCarroucelInterval] =
    useState<NodeJS.Timer | null>(null);

  useEffect(() => {
    setCarroucelInterval(
      setInterval(() => {
    ...
    return () => {
      if (carroucelInterval) clearInterval(carroucelInterval);
    };
  }, []);
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      },
      {
        root: null, // Use null para o viewport
        rootMargin: "0px", // Margem adicional em relação ao viewport
        threshold: 1, // Quanto do elemento precisa estar visível para ser considerado visível
      }
    );
  ...
  return (
    <div className="w-full overflow-x-hidden max-w-[100vw]">
      ...
      <div className="sm:mx-12 md:mx-24 lg:mx-48 mx-auto mb-12 flex justify-center">
        <div className="max-w-[1280px] px-4 sm:px-0">
          ...
          <p className="text-left text-lg mt-4 text-neutral-700 font-normal ">
            ...
            de impressão, desde cartões de visita, etiquetas, cartazes,
            panfletos até onde a sua criatividade chegar. Tudo isso com a{" "}
            <span className="text-neutral-900 font-bold">qualidade</span> que
            você espera e um{" "}
            <span className="text-neutral-900 font-bold">
      ...
      <div className="mb-12 mt-8 flex justify-center gap-6 sm:mx-12 md:mx-24 lg:mx-48 mx-auto">
        <div className="max-w-[1280px] px-4 sm:px-0 flex">
          <div className="grow p-6 flex flex-col items-center justify-center">
            ...
            >
              ...
              Nossa equipe está sempre pronta para ajudar e oferecer sugestões
              para tornar o seu projeto ainda melhor.
            </p>{" "}
          ...
          <div className="grow p-6 flex flex-col items-center justify-center">
            ...
            >
              ...
              garantimos uma produção rápida e eficiente para que você receba
              suas impressões no prazo prometido.
            </p>{" "}
            <div className="flex justify-center items-center w-full">
              <div
                className={`${
          ...
          <div className="grow p-6 flex items-center flex-col justify-center">
            ...
            >
              ...
              tenham um acabamento perfeito. Trabalhamos com materiais de
              primeira qualidade e equipamentos modernos para garantir que suas
              ideias sejam traduzidas em impressões incríveis.
            </p>{" "}
            <div className="flex justify-center items-center w-full">
              <div
                className={`${
      ...
      <div className="sm:mx-12 md:mx-24 lg:mx-48 mx-auto mt-16 mb-12 flex justify-center">
        <div className="max-w-[1280px] px-4 sm:px-0">
          <p className="text-left text-3xl my-6 text-neutral-900 font-bold">
            Atendimento ao cliente excepcional
          </p>
          <p className="text-left text-lg mt-4 text-neutral-700 font-normal ">
            Estamos à disposição para auxiliar em qualquer dúvida ou questão.
            Não hesite em nos contatar a qualquer momento; ficaremos felizes em
            ajudar!
          </p>

          <div
            className={`${
              isVisible2 ? "translate-x-0" : "translate-x-[150%]"
            } w-full overflow-hidden h-[2px] transition duration-1000 delay-500 ease-in bg-neutral-300 mt-8 mb-12`}
          />

          <div className="flex justify-between gap-8 px-8">
            <p
              className={`text-center text-base w-1/2 text-ersPrimaryDark font-normal ${
            ...
            >
              "Estou encantado com a qualidade do serviço da ERS Print.
              Entregaram exatamente o que eu precisava, dentro do prazo e com
              atendimento excepcional. Recomendo sem hesitar!"
            </p>
          </div>
